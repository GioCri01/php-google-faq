...
$faq =[
    [
        "title" => '<p>Come state implementando la recente decisione della Corte di giustizia dell Unione europea (CGUE) relativa al diritto alloblio?',
...
<body>
    <header class="container-fluid position-fixed " >
        <img src="https://upload.wikimedia.org/wikipedia/commons/5/51/Google.png" alt="logo">
        <nav >
